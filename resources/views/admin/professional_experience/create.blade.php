<x-app-layout>
    ...
    -->
    <x-card>
        <h1 class="font-bold text-lg pb-10 w-4/5">{{ __('Nova Experiência Profissional') }}</h1>
        ...
        <form method="POST" action="/admin/experience">
            ...
            <div class="flex mt-5">
                <div class="w-1/2">
                    ...
                    <x-input id="start_datetime" class="block mt-1 w-full" type="date" name="start_datetime" :value="old('start_datetime')" required />
                </div>
                <div class="w-1/2 ml-5">
                    <x-label for="subtitle" class="font-bold" :value="__('Data Fim')" />

                    <x-input id="finish_datetime" class="block mt-1 w-full" type="date" name="finish_datetime" :value="old('finish_datetime')"/>
                </div>
            </div>
            <div class="flex py-5 justify-end">
                <label class="inline-flex items-center">
                    <input type="checkbox" id="is_current" name="is_current" class="form-checkbox">
