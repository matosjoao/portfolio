<x-app-layout>
    ...
    -->
    <x-card>
        <h1 class="font-bold text-lg pb-10 w-4/5">{{ __('Novo Hobbie') }}</h1>

        <form method="POST" action="/admin/hobbie">
            @csrf
            <!-- Title -->
            <div>
            ...
            <div>
                ...
                <x-input id="order_number" class="block mt-1 w-full" type="number" name="order_number" :value="old('order_number')" required autofocus />
            </div>
