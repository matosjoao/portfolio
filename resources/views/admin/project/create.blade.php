<x-app-layout>
    ...
    -->
    <x-card>
        <h1 class="font-bold text-lg pb-10 w-4/5">{{ __('Novo Projeto') }}</h1>
        ...
        <form method="POST" action="/admin/project" enctype="multipart/form-data">
            ...
            <div class="mt-5">
                ...
                <x-input id="order_number" class="block mt-1 w-full" type="number" name="order_number" :value="old('order_number')" required />
            </div>
            <!-- Active/Highlighted -->
            <div class="flex py-5 justify-center">
                <label class="inline-flex items-center mr-10">
                    <input type="checkbox" id="highlighted" name="highlighted" class="form-checkbox">
